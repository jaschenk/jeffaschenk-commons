 ...
 * <br>
 * <b>Usage:</b><br>
 * IRRProduceGMDLDIFBulk &lt;Required Parameters&gt; &lt;Optional Parameters&gt;
 * <br>
 * <b>Required Parameters are:</b>
 * <pre>
 * --gmddir
 * 	Specify Full Path of teh directory containing the GMDs
 * --ldifout
 * 	Specify Full Path of LDIF Output File.
 * --entrydn
 * 	Specify the relative dn. (xen=&lt;name&gt; will be prepended)
 * </pre>
...
public class IRRProduceGMDLDIFBulk implements idxCMDReturnCodes {

    private static String VERSION = "Version: 1.0 2001-09-07, " +
            "FRAMEWORK, Incorporated.";

    private static String MP = "IRRProduceGMDLDIFBulk: ";

    private static String ldifoutputfilename = null;

    private static String gmdIndirName = null;
    ...
    static void Usage() {
        ...
        System.err.println(MP + "IRRProduceGMDLDIFBulk <Required Parameters> <Optional Parameters>");

        System.err.println("\n" + MP + "Required Parameters are:");

        System.err.println(MP + "--gmddir ");
        System.err.println("\tSpecify Full Path of teh directory containing the GMDs");
        System.err.println(MP + "--ldifout ");
        System.err.println("\tSpecify Full Path of LDIF Output File.");
        System.err.println(MP + "--entrydn ");
        System.err.println("\tSpecify the relative dn. (xen=<name> will be prepended)");
    ...
    /**
     * IRRProduceGMDLDIFBulk Contructor class driven from
     * Main or other Class Caller.
     *
     * @param _KentryDN  Entry DN to be written.
     * @param _gmdIndirName  XML Input File.
     ...
     *
     */
    public IRRProduceGMDLDIFBulk(String _KentryDN,
                                 String _gmdIndirName,
    ...
    } // End of Constructor for IRRProduceGMDLDIFBulk.
    ...
    public void perform() throws Exception, idxIRRException {
        ...
        File gmdDir = new File(gmdIndirName);
        File[] files = gmdDir.listFiles();
        if (files == null) {
            System.err.println("Supplied path is not a directory:" + gmdIndirName);
            System.exit(EXIT_IRR_ERROR_PROCESSING_INPUT_FILE);
        } else if (files.length == 0) {
            System.err.println("Directory contains no files:" + gmdIndirName);
            System.exit(EXIT_IRR_ERROR_PROCESSING_INPUT_FILE);
        }
        ...
        for (int i = 0; i < files.length; i++) {
            String KentryDN = this.KentryDN;
            String xslInfileName = files[i].getCanonicalPath();
            StringBuffer xslStringBuffer = null;

            if ("1_output.xml".equals(files[i].getName())) {
                // special case, do not add gmd tree
                continue;
            } else {
     ...
     * @see jeffaschenk.commons.frameworks.cnxidx.admin.IRRProduceGMDLDIFBulk
     */
    public static void main(String[] args) {
        ...
        VAR.add(new idxArgVerificationRules("gmddir",
                true, true));
        ...
        //
        gmdIndirName = ((String) Zin.getValue("gmddir")).trim();
        System.out.println(MP + "GMDDir:[" + gmdIndirName + "]");
        ...
        IRRProduceGMDLDIFBulk FUNCTION = new IRRProduceGMDLDIFBulk(
                KentryDN,
                gmdIndirName,
                ldifoutputfilename,
                Kcomment,
        ...
        try {
            ...
            System.err.println(MP + "IRR Exception Performing IRRProduceGMDLDIFBulk.\n" + e);
...
} // End of Class IRRProduceGMDLDIFBulk
